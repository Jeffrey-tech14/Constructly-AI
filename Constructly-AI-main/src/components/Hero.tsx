        ...
        <div className="relative z-20 w-full max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8 flex items-center h-full">
          <div className="w-full lg:w-[55%] pt-2 text-center lg:text-left">
            ...
            >
              <div className="mb-3">
                <p
                  className="text-[8px] sm:text-[9px] font-bold tracking-[0.2em] mb-1.5 uppercase opacity-90"
              ...
              <div className="flex flex-col sm:flex-row gap-2.5 mt-4 justify-center lg:justify-start">
                <motion.button
                  ...
                  className="text-white text-[9px] sm:text-[10px] font-bold uppercase px-4 py-2 rounded-full shadow transition-all tracking-wider hover:brightness-110 flex items-center justify-center gap-1.5"
                ...
                <motion.button
                  ...
                  className="bg-white text-[#000B29] text-[9px] sm:text-[10px] font-bold uppercase px-4 py-2 rounded-full shadow transition-all tracking-wider hover:bg-gray-100 flex items-center justify-center gap-1.5"
                >
              ...
              <div className="mt-3 flex flex-col sm:flex-row sm:items-center gap-2 text-[10px] font-medium justify-center lg:justify-start">
                <motion.button
                  ...
                  whileTap={{ scale: 0.97 }}
                  onClick={openDemoVideo}
                  className="flex items-center gap-1 text-white/80 hover:text-white transition-colors justify-center sm:justify-start px-3 py-1 rounded-full bg-white/10 backdrop-blur-sm"
                >
