...
export default function PricingSection({
  ...
  if (tiersLoading) {
    return (
      <div className="flex flex-col justify-center items-center py-40 bg-gray-50 font-outfit">
  ...
  if (tiersError) {
    return (
      <div className="flex flex-col justify-center items-center py-40 bg-gray-50 text-red-600 font-outfit">
  ...
  return (
    <>
      ...
      <div
        id="pricing"
        className="font-outfit text-[#1a1a1a] bg-gray-50 antialiased min-h-screen"
      >
        {/* =========================================
          1. HERO SECTION
      ========================================= */}
          ...
          <div className="relative z-10 max-w-5xl mx-auto px-6 h-full flex flex-col justify-center">
            ...
            >
              ...
              <p className="text-base text-gray-300 font-light max-w-lg leading-relaxed">
                Select the perfect plan for your needs. Upgrade or cancel at any
                time.
              </p>
            </motion.div>
          </div>
          ...
          <div className="max-w-5xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {tiers?.map((plan, index) => {
                ...
                const IconComponent =
                  index === 0 ? Zap : index === 1 ? Briefcase : Building2;
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex items-center gap-3 mb-5">
                      {/* Smaller Icon Circle */}
                      <div
                        className={`w-10 h-10 rounded-full flex items-center justify-center shrink-0 ${theme.iconBg}`}
                      >
                        {plan.image ? (
                          <img
                            src={plan.image}
                      ...
                      <div>
                        ...
                        {/* Sharper Subtitle */}
                        <div
                          className={`text-[10px] font-bold uppercase tracking-wider ${theme.accentColor}`}
                        >
                          {theme.subtitle}
                        </div>
                      </div>
                    ...
                    <ul className="space-y-2.5 mb-6 flex-grow">
                      {plan.features?.slice(0, 5).map((feature, idx) => (
                        ...
                        >
                          <Check
                            className={`w-4 h-4 mt-0.5 flex-shrink-0 ${theme.accentColor}`}
                          />
                          <span>{feature}</span>
                        </li>
                      ))}
