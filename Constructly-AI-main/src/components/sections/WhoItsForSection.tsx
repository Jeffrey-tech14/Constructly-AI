  ...
  const professionals = [
    {
      ...
      description:
        "Manage bids and verify estimates in one place—no spreadsheets, no guesswork.",
      cta: "FOR GCs",
      gradient: "from-[#1e40af] to-[#3b82f6]",
      shadow: "shadow-blue-500/30",
      borderColor: "#1e40af",
      imageUrl:
        "https://contractortrainingcenter.com/cdn/shop/articles/general_contractors_making_plans_for_new_project_smaller_520x500_db69fb37-61b4-4727-827a-b631920e58ba.jpg?v=1736785491",
    },
    {
      icon: <FileText className="text-white h-7 w-7" />,
      title: "Quantity Surveyors",
      description:
        "Automate takeoffs. Focus on high-value analysis—not manual counts.",
      cta: "FOR QS",
    ...
    },
    {
      ...
      title: "AI Estimators",
      description:
        "Catch costly errors before they happen. AI double-checks every number.",
      cta: "FOR ESTIMATORS",
      gradient: "from-[#475569] to-[#94a3b8]",
      shadow: "shadow-slate-500/30",
      borderColor: "#475569",
      imageUrl:
        "https://media.licdn.com/dms/image/v2/D5612AQEgIIu1uMeXjw/article-cover_image-shrink_720_1280/B56ZfPIJJ6G0AI-/0/1751526709444?e=2147483647&v=beta&t=-vJDyuhNgfNtOTfhjzMw9Qc5c4VuuG6S9_r6Ye8bXWw",
    },
    {
      icon: <BarChart3 className="text-white h-7 w-7" />,
      title: "Construction Managers",
      description:
        "Track costs in real time. Approve change orders with confidence.",
      cta: "FOR MANAGERS",
      gradient: "from-[#0d9488] to-[#2dd4bf]",
      shadow: "shadow-teal-500/30",
      borderColor: "#0d9488",
      imageUrl:
        "https://lh6.googleusercontent.com/proxy/lnwMTl77W7My0yMPlJmq7E1ihUQxgHX5rb0NVE1v1Olbx3dzgCxL61HKUl9NsWuhxIuk8PQiUvzgWPkhqB5Kt2c_fh6bDfNdN9ROKEh8MY0J2xA-7C_61cIOhMYQtoRtEXlmoP_fpXWB_MPts3WLQHZidg",
    },
    {
      icon: <Home className="text-white h-7 w-7" />,
      title: "Home Builders",
      description:
        "Turn plans into precise material lists—and trustworthy client quotes.",
      cta: "FOR BUILDERS",
      gradient: "from-[#ea580c] to-[#fb923c]",
      shadow: "shadow-orange-500/30",
      borderColor: "#ea580c",
      imageUrl:
        "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQzbySqaSyzlTf8xu19--yNQ9Y_Ov9HDgP4MQ&s",
    },
  ];

  return (
    <div id="who-its-for" className=" text-[#333333] bg-[#F0F7FA] antialiased">
      {/* BASICS TO MASTERY */}
      <section className="bg-[#F0F7FA] py-24 border-b border-[#E1EBF2]">
          ...
          <div className="flex flex-col lg:flex-row items-center gap-20">
            ...
            <div className="w-full lg:w-[55%]">
              ...
              <p className="text-[15px] text-[#555] leading-relaxed">
                Guided resources grow with you, from first bid to full
                automation.
              </p>
            </div>
          </div>
      ...
      {/* CARD GRID */}
      <section className="bg-[#F0F7FA] py-24">
        <div className="max-w-[1240px] mx-auto px-6">
          <div className="mb-12">
            ...
            <p className="text-[15px] text-[#666] max-w-2xl leading-relaxed">
              AI workflows tailored to what you do—so you ship estimates, not
              spreadsheets.
            </p>
          </div>
            ...
            {professionals.map((pro, index) => (
              ...
              >
                ...
                <div className="w-full p-4 mt-4 bg-gray-50 border-t border-gray-200 flex items-center justify-start">
                  ...
                  >
                    {pro.cta}{" "}
                    <ChevronRight className="inline-block w-4 h-4 ml-1 relative bottom-[1px]" />
                  </button>
                </div>
              </motion.div>
            ))}
        ...
        <div className="max-w-[1240px] mx-auto px-6">
          ...
          <div className="flex flex-col lg:flex-row-reverse gap-10 lg:gap-16 items-center">
            ...
            <div className="lg:w-1/2 flex flex-col justify-center">
              <h2 className="text-[30px] font-bold mb-6">Support That Works</h2>
