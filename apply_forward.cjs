...
const newImg =               <div className="hidden lg:flex relative w-full h-[400px] justify-center items-center drop-shadow-[0_20px_40px_rgba(239,68,59,0.15)]">
                <img
                  src="https://img.freepik.com/premium-photo/ai-construction-worker-holds-ai-construction-site-while-using-ai-construction-site_111797-2516.jpg"
                  alt="Technical Operations Support"
                  className="w-full h-[400px] object-cover rounded-xl transform-gpu hover:scale-[1.02] transition-transform duration-500"
                />
              </div>;
