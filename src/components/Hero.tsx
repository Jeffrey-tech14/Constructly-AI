  ...
  return (
    ...
    >
      ...
      <section className="relative w-full min-h-[50vh] lg:min-h-[600px] overflow-hidden flex items-center pt-16 lg:pt-0">
        ...
        <div className="relative z-20 w-full min-h-screen max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8 flex items-center h-full">
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row gap-2.5 mt-4 justify-center lg:justify-start">
                <motion.button
                  ...
                  className="text-white text-[9px] rounded-3xl sm:text-[10px] font-bold uppercase px-3 py-1.5 rounded-[2px] shadow transition-all tracking-wider hover:brightness-110 flex items-center justify-center gap-1.5"
                ...
                >
                  <PlayCircle className="w-2.5 h-2.5 text-[#0696D7]" /> Get
                  Started
                </motion.button>
              </div>
