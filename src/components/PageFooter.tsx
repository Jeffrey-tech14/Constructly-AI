...
const Footer = ({ scrollTo }: { scrollTo: (section: string) => void }) => {
  ...
  return (
    <>
      ...
      <footer
        id="contact"
        className="bg-[#F0F7FA] border-t border-[#E1EBF2] pt-20 pb-10 font-outfit text-[#1a1a1a]"
      >
        <div className="max-w-[1250px] mx-auto px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8 mb-16">
            ...
            <div className="flex flex-col items-start">
              ...
              <p className="text-gray-600 text-sm leading-relaxed mb-8 max-w-xs font-medium">
                Next-generation construction estimation powered by artificial
                intelligence. Built for precision, speed, and reliability.
              </p>
            ...
            <div>
              ...
              <div className="space-y-5">
                ...
                <a
                  ...
                  className="flex items-center gap-3 text-gray-600 hover:text-[#005F9E] transition-colors"
                >
            ...
            <div>
              ...
              <p className="text-gray-600 text-sm mb-4 font-medium">
                Subscribe to our newsletter for the latest AI engineering
                updates.
              </p>
          ...
          <div className="border-t border-[#E1EBF2] pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex gap-6">
              <a
                href="#"
                className="text-xs text-gray-500 hover:text-[#005F9E] transition-colors font-medium"
              >
                Privacy Policy
              </a>
              <a
