      ...
      <div>
        ...
        {expandedSections.location && (
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pl-3">
            <div>
              <Label htmlFor={`location-${painting.id}`} className="text-xs ">
                Location Name
              </Label>
              <Input
            ...
            <div>
              <Label htmlFor={`area-${painting.id}`} className="text-xs ">
                Surface Area (m²)
              </Label>
              <Input
                id={`area-${painting.id}`}
      ...
      <div>
        ...
        {expandedSections.finishing && (
          <div className="space-y-4 pl-3">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <Label htmlFor={`category-${painting.id}`} className="text-xs ">
                  Paint Type
                </Label>
                <Select
              ...
              <div>
                <Label htmlFor={`subtype-${painting.id}`} className="text-xs ">
                  Finish Level
                </Label>
                <Select
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <Label htmlFor={`coats-${painting.id}`} className="text-xs ">
                  Number of Coats
                </Label>
                <Select
              ...
              <div>
                <Label htmlFor={`coverage-${painting.id}`} className="text-xs ">
                  Coverage (m²/L)
                </Label>
                <Input
