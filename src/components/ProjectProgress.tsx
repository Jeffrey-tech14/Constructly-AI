    ...
    <Card className="bg-transparent">
      ...
      <CardContent className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            <Label className='text-white' htmlFor="status">Project Status</Label>
            <Select 
          ...
          <div>
            <Label className='text-white' htmlFor="percentage">Progress Percentage</Label>
            <Input
              id="percentage"
              type="number"
              min="0"
        ...
        <div>
          <Label className='text-white' htmlFor="milestone">Next Milestone Date</Label>
          <Input
            id="milestone"
            type="date"
        ...
        <div>
          <Label className='text-white' htmlFor="notes">Progress Notes</Label>
          <Textarea
            id="notes"
