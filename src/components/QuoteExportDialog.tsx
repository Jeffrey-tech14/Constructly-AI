...
export const QuoteExportDialog = ({ quote, open, onOpenChange, contractorName, companyName, logoUrl, }: QuoteExportDialogProps) => {
    const [exportType, setExportType] = useState<"client" | "contractor">("contractor");
    ...
    return (<div className="space-y-6">
      {isProcessing ? (<div className="flex flex-col items-center justify-center space-y-3 bg-green-50 dark:bg-green-900  border border-green-400 dark:border-green-400 rounded-lg p-4">
          ...
          <div className="space-y-4">
            <div>
              ...
              <Select onValueChange={(value: "client" | "contractor") => setExportType(value)} value={exportType} disabled={isProcessing}>
                <SelectTrigger>
            ...
            <div>
              ...
              <Select onValueChange={(value: "pdf" | "excel" | "docx") => setExportFormat(value)} value={exportFormat} disabled={isProcessing}>
                <SelectTrigger>
            ...
            <Button onClick={handleExport} className="w-full text-white flex items-center justify-center space-x-2" disabled={isProcessing}>
