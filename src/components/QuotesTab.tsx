      ...
      <CardContent className="space-y-4">
        <div className="flex flex-col md:flex-row md:items-center gap-4 mb-4">
          <div className="relative flex-1">
            ...
            <Input placeholder="Search contractor..." value={searchTerm} onChange={(e) => setSearchTerm(e.target.value)} className="pl-10"/>
          </div>
        ...
        {filteredQuotes.length === 0 && (<p className="text-center text-muted-foreground">No quotes found</p>)}

        <div className="grid w-full grid-cols-1 md:grid-cols-2">
          {filteredQuotes.map((quote) => (<Card key={quote.id} className="border  rounded-lg p-4 m-2 space-y-2">
