...
const Reports = () => {
    ...
    return (<div className="space-y-6 animate-fade-in">
      <div className="flex justify-between items-center">
        ...
        <Button className="text-white" onClick={handleRefresh} disabled={refreshing || quotesLoading || reviewsLoading}>
      ...
      {userQuotes.length > 0 && (<div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          <Card className="">
            <CardHeader>
            ...
            <CardContent>
              <ResponsiveContainer width="100%" height={300}>
                <BarChart data={monthlyData}>
                  ...
                  <Tooltip labelClassName="text-black rounded-lg" formatter={(value) => [
                `KSh ${formatCurrency(Number(value))}`,
                "Revenue",
            ]}/>
                  <Bar className="rounded-lg" dataKey="revenue" fill="#22c55e" radius={[4, 4, 0, 0]}/>
                </BarChart>
              </ResponsiveContainer>
            </CardContent>
          </Card>
          ...
          {monthlyData.length > 0 && (<Card className=" lg:col-span-2">
              <CardHeader>
              ...
              <CardContent>
                <ResponsiveContainer width="100%" height={300}>
                  <LineChart data={monthlyData}>
                    ...
                    <XAxis dataKey="name"/>
                    <YAxis />
                    <Tooltip labelClassName="text-black rounded-lg" formatter={(value) => [`${value}`, "Quotes"]}/>
