      ...
      <div className="flex-grow bg-white border border-[#d1d5db] rounded-xl shadow-sm hover:shadow-md transition-all duration-300 group overflow-hidden">
        <div className="p-6 md:p-8">
          ...
          <div className="border border-[#e5e7eb] rounded-lg mb-4 overflow-hidden">
            ...
            >
              <span className={`font-medium text-[12px] ${isOpenMain ? "text-[#00356B]" : "text-gray-700"}`}>
                {faq.question}
              </span>
              {isOpenMain ? (
          ...
          {faq.historyText && (
            <div className="border border-[#e5e7eb] rounded-lg overflow-hidden">
              ...
              >
                <span className={`font-medium text-[12px] ${isOpenSub ? "text-[#00356B]" : "text-gray-500"}`}>
                  {faq.historyText}
                </span>
                {isOpenSub ? (
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div className="w-full max-w-lg">
                ...
                >
                  ...
                  <span className="font-bold text-[#00356B] block mt-1">Support Hub</span>
                </motion.h1>
                ...
                <div className="flex h-12 w-full border border-[#d1d5db] rounded-md overflow-hidden shadow-sm">
                  ...
                  <button
                    className="h-full px-6 bg-[#00356B] text-white font-black text-[10px] uppercase tracking-[1.5px] hover:bg-[#002a54] transition-colors"
                  >
                    Search
                  </button>
                </div>
          ...
          <div className="w-full md:flex-1">
            <div className="flex flex-col sm:flex-row items-center justify-between text-[12px] text-gray-500 mb-8 pb-4">
              ...
              <div className="flex items-center gap-4 mt-3 sm:mt-0">
                <span className="font-bold uppercase tracking-wider text-gray-500">Sort By:</span>
