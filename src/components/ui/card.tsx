...
const Card = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(({ className, ...props }, ref) => (<div ref={ref} className={cn("rounded-lg glass-strong dark:glass border border-gray-100 dark:border-gray-600 text-card-foreground shadow-sm", className)} {...props}/>));
...
const CardTitle = React.forwardRef<HTMLParagraphElement, React.HTMLAttributes<HTMLHeadingElement>>(({ className, ...props }, ref) => (<h3 ref={ref} className={cn("sm:text-lg text-md font-semibold leading-none tracking-tight", className)} {...props}/>));
