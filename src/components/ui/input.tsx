  ...
  (
    ...
    return (
      <input
        type={type}
        className={cn(
          "flex h-10 w-full rounded-3xl border border-input bg-white dark:bg-background px-3 py-2 text-base ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium file:text-foreground placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 text-sm",
          className,
        )}
        ref={ref}
        value={displayValue}
