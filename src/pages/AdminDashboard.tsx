                        ...
                        <div className="flex flex-col md:flex-row md:items-center justify-between gap-3">
                          <div className="flex items-start md:items-center space-x-3 md:space-x-4 flex-1 min-w-0">
                            <div className="sm:w-8 sm:h-8 md:w-10 md:h-10 h-9 w-9 bg-primary/10 rounded-full flex items-center justify-center flex-shrink-0 dark:bg-white/10 bg-primary/10">
                              <Avatar className="sm:w-8 sm:h-8 md:w-10 md:h-10 h-9 w-9 items-center justify-center text-center">
                                <AvatarImage
                                  src={user?.avatar_url || undefined}
                                />
                                <AvatarFallback className="items-center justify-center text-center">
                                  <Users className="w-4 h-4 justify-center text-center text-blue-600 dark:text-blue-400" />
                                </AvatarFallback>
                              </Avatar>
                            </div>
