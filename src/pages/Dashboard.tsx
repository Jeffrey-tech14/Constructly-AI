                ...
                <Card className="gradient-card card-hover">
                  ...
                  <CardContent>
                    <div className="sm:text-2xl text-lg font-bold flex items-center">
                      ...
                      {averageRating > 0 && (
                        <Star className="w-5 h-5 ml-1 text-blue-400 fill-current" />
                      )}
                    </div>
                    <p className="text-xs text-muted-foreground">
                  ...
                  <div className="space-y-4">
                    {dashboardData.recentQuotes.length > 0 ? (
                      dashboardData.recentQuotes.map((quote) => (
                        <div
                          key={quote.id}
                          className="flex items-center justify-between p-4 dark:bg-gray-900 border border-gray-100 dark:border-gray-600/40 rounded-lg hover:shadow-lg transition-shadow"
                        >
