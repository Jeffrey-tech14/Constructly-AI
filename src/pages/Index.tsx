...
const Index = () => {
  ...
  return (
    <div className="min-h-screen text-foreground selection:bg-blue-200 dark:selection:bg-blue-800">
      ...
      <BackdropOrbs />
      <div className="absolute inset-0 bg-gradient-to-tr from-primary/10 via-transparent to-blue-200/30 mix-blend-overlay pointer-events-none animate-pulse" />
      ...
      >
        <div className="w-full h-full mx-auto px-4 sm:px-6 lg:px-8 py-24 sm:py-28 mb-10">
          <div className="mx-auto text-center">
            <Badge
              variant="outline"
              className="bg-blue-50 dark:bg-blue-950/30 border-blue-200 dark:border-blue-800 text-blue-700 dark:text-blue-300 rounded-full px-4 py-1"
            >
              <Star className="w-4 h-4 mr-1 inline" /> Professional Construction
              Management
            </Badge>
            ...
            <p className="mt-6 text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto">
              Streamline your business with takeoffs, BOQs, and client-ready
              proposals — built for contractors in Kenya.
            </p>
      ...
      <section className="py-14" aria-labelledby="who-title">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <SectionHeading
            id="who-title"
            eyebrow="Tailored for your workflow"
            title="Who It’s For"
          />
            ...
            {[
              {
                emoji: "🏗️",
                role: "Contractors",
                desc: "Bring your own rates & margins.",
              },
              {
                emoji: "📐",
                role: "Quantity Surveyors",
                desc: "Takeoffs, BOQs & exports.",
              },
              {
                emoji: "🏘️",
                role: "SMEs & Developers",
                desc: "Clear pricing, better decisions.",
              },
            ].map((item, i) => (
              <Card
                key={i}
                className="rounded-2xl bg-white/70 dark:bg-slate-900/60 border border-white/40 dark:border-slate-800 shadow-lg hover:shadow-xl transition-transform hover:-translate-y-1"
              >
            ...
            {[
              {
                ...
                description:
                  "Detailed, accurate proposals with your rates, margins, and timelines.",
              },
              {
                icon: <Calculator className="w-7 h-7" />,
                title: "Cost Calculator",
                description:
                  "Live calculations with regional multipliers and service rates.",
              },
              {
                icon: <Users className="w-7 h-7" />,
                title: "Client Management",
                description:
                  "Track clients, projects, and approvals in one place.",
              },
              {
                icon: <TrendingUp className="w-7 h-7" />,
                title: "Business Analytics",
                description:
                  "See revenue, conversion, and project KPIs at a glance.",
              },
              {
                icon: <Building className="w-7 h-7" />,
                title: "Project Types",
                description:
                  "Residential, commercial, and infrastructure supported.",
              },
              {
                icon: <Clock className="w-7 h-7" />,
                title: "Time Tracking",
                description:
                  "Keep timelines on track with milestones and reminders.",
              },
            ].map((f, i) => (
              <Card
                key={i}
              ...
              >
                <CardContent className="p-8">
                  <div className="mb-4 w-fit p-3 rounded-xl dark:text-white shadow-md">
                    {f.icon}
                  </div>
      ...
      <section id="benefits" className="py-16" aria-labelledby="benefits-title">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <SectionHeading
            id="benefits-title"
            eyebrow="Benefits"
            title="Why construction professionals choose us"
          />
        </div>
            ...
            {[
              {
                ...
                title: "1. Set your rates",
                desc: "Enter material and service rates. Add transport rates and custom prices for equipment.",
              },
              {
                icon: <Ruler className="w-7 h-7" />,
                title: "2. Analyze plans",
                desc: "Upload drawings, run takeoffs, and generate quantities instantly.",
              },
              {
                icon: <Hammer className="w-7 h-7" />,
                title: "3. Send proposals",
                desc: "Export branded quotes and BOQs. Win more jobs with clarity.",
              },
            ].map((s, i) => (
              <Card
                key={i}
                className="transition-transform hover:-translate-y-1 rounded-2xl bg-white/70 dark:bg-slate-900/60 border border-white/40 dark:border-slate-800 shadow-lg"
              >
                <CardContent className="p-8">
                  <div className="mb-4 w-fit p-3 rounded-xl dark:text-white shadow-md">
                    {s.icon}
      ...
      <section id="faq" className="py-16" aria-labelledby="faq-title">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-6">
            <Accordion
              type="multiple"
              className="rounded-2xl bg-white/70 dark:bg-slate-900/60 border border-white/40 dark:border-slate-800 shadow-lg overflow-hidden"
            >
              {[
                {
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <Card className="rounded-3xl bg-gradient-to-r from-blue-600 to-purple-600 text-white shadow-2xl">
            <CardContent className="p-10 flex flex-col md:flex-row items-center justify-between gap-6">
              <div>
                <p className="uppercase tracking-wider text-white/80 text-xs mb-1">
...
const SectionHeading = ({
  ...
  <div id={id} className="text-center">
    {eyebrow && (
      <p className="uppercase tracking-widest text-xs text-blue-700/80 dark:text-blue-300/80">
        {eyebrow}
      </p>
    )}
