...
import { Search, Eye, FileText, TrendingUp, Building2, MapPin, Calendar, Trash2, Pen } from 'lucide-react';
      ...
      <div className="grid gap-6">
        {filteredQuotes.length === 0 ? (
          ...
          filteredQuotes.map((quote) => (
            <Card key={quote.id} className="gradient-card hover:shadow-lg shadow-sm">
              <CardHeader>
                  ...
                  <Card className="bg-background/50">
                    <CardContent className="text-center p-4">
                      ...
                      <div className="text-lg font-semibold text-purple-600">
                        KSh {(formatCurrency(quote.additional_services_cost).toLocaleString())}
                      </div>
                    </CardContent>
                  </Card>
                </div>
