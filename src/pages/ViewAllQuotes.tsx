...
import { Search, Eye, FileText, TrendingUp, Building2, MapPin, Calendar, Trash2, Pen, Pickaxe, } from "lucide-react";
...
const ViewAllQuotes = () => {
    ...
    const [selectedQuoteForExport, setSelectedQuoteForExport] = useState<any>(null);
    ...
    const contractorName = profile?.name ||
      ...
      <div className="container mx-auto px-4 py-8">
          ...
          <CardContent className="p-6">
            <div className="flex flex-col md:flex-row gap-4">
              <div className="relative flex-1">
                ...
                <Input placeholder="Search quotes by title or client name..." value={searchTerm} onChange={(e) => setSearchTerm(e.target.value)} className="pl-10 h-11"/>
              </div>
        ...
        <div className="grid gap-6">
          {filteredQuotes.length === 0 ? (<Card>
            ...
            return (<Card key={quote.id} className=" hover:shadow-lg shadow-sm">
                  <CardHeader>
                    <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                      ...
                      <div className="flex flex-col md:flex-row items-start md:items-center gap-3">
                        {profile.tier !== "Free" && (<Badge className={getStatusColor(quote.status)}>
                  ...
                  <CardContent>
                      ...
                      <Card className="dark:bg-gray-900">
                        <CardContent className="text-center p-4">
                          ...
                          <div className="text-lg font-semibold text-purple-600">
                            KSh{" "}
                            {formatCurrency(quote.additional_services_cost).toLocaleString()}
                          </div>
                        </CardContent>
                      </Card>
                    </div>

                    {quote.custom_specs && (<Card className="dark:bg-gray-900 mb-6">
                    ...
                    <div className="flex flex-wrap gap-3">
                      <Dialog>
                        <DialogTrigger asChild>
                          <Button variant="outline" size="sm" className="flex-1 sm:flex-none" onClick={() => setSelectedQuote(quote)}>
                    ...
                    quote.masonry_materials.length > 0 && (<div>
                                  <h4 className="font-semibold mb-3 text-white">
                                    Materials
                                  </h4>
                                  <div className="space-y-2">
                                    {quote.masonry_materials.map((material: any, index: number) => (<div key={index} className="flex justify-between items-center p-3 rounded">
                                          <div>
                                          ...
                                          <span className="font-semibold text-white">
                                            KSh{" "}
                                            {formatCurrency(material.total_price || 0).toLocaleString()}
                                          </span>
                                        </div>))}
                                  </div>
                                </div>)}
                            ...
                            {quote.equipment && quote.equipment.length > 0 && (<div className="flex justify-between">
                            ...
                            {quote.transport_costs > 0 && (<div className="flex justify-between">
                                <p className="text-white">
                            ...
                            {quote.additional_services_cost > 0 && (<div className="flex justify-between">
                                <p className="text-white">
                                ...
                                <p className="text-white">
                                  <strong>
                                    KSh{" "}
                                    {formatCurrency(quote.additional_services_cost)}
                                  </strong>
                                </p>
                              </div>)}
                            {quote.addons_cost > 0 && (<div className="flex justify-between">
                                <p className="text-white">
                            ...
                            {quote.materials_cost > 0 && (<div className="flex justify-between">
                                <p className="text-white">
                            ...
                            {quote.permit_cost > 0 && (<div className="flex justify-between">
                                <p className="text-white">
                            ...
                            {quote.overhead_amount > 0 && (<div className="flex justify-between">
                                <p className="text-white">
                            ...
                            {quote.contingency_amount > 0 && (<div className="flex justify-between">
                                <p className="text-white">
                        ...
                        0}
                            ...
                            {quote.labor_cost > 0 && (<div className="flex justify-between">
                                <p className="text-white">
                            ...
                            {quote.profit_amount > 0 && (<div className="flex justify-between">
                                <p className="text-white">
                            ...
                            {quote.total_amount > 0 && (<div className="flex justify-between">
                                <p className="text-white">
                                  <strong>Total</strong>
                                </p>
                                <p className="text-white">
                      ...
                      {profile.tier !== "Free" && (<Dialog>
                          ...
                          <DialogContent className="max-w-2xl">
                            ...
                            <ProjectProgress quoteId={quote.id} quoteName={quote.title} onQuoteUpdated={() => setQuotesRefreshKey((k) => k + 1)}/>
                          </DialogContent>
                        </Dialog>)}
                      ...
                      <Dialog>
                        <DialogTitle></DialogTitle>
                        <DialogTrigger asChild>
                          <Button size="sm" onClick={() => setSelectedQuoteForExport(quote)} className="text-white flex-1 sm:flex-none bg-gradient-to-r from-primary to-blue-600 hover:from-primary/90 hover:to-blue-900/90">
                            <FileText className="w-4 h-4 mr-2 text-white"/>
                            Generate BOQ
                          </Button>
                        </DialogTrigger>
                        <DialogContent>
                          {selectedQuoteForExport && (<QuoteExportDialog open={!!selectedQuoteForExport} onOpenChange={(open) => {
                        if (!open)
                            setSelectedQuoteForExport(null);
                    }} quote={selectedQuoteForExport} contractorName={contractorName} companyName={companyName} logoUrl={profile.avatar_url}/>)}
                        </DialogContent>
                      </Dialog>

                      {profile.tier !== "Free" && (<Button size="sm" onClick={() => navigate("/quotes/new", { state: { quote } })} className="text-white flex-1 sm:flex-none bg-gradient-to-r from-green-800 to-green-600 hover:from-green-900 hover:to-green-700">
                      ...
                      <AlertDialog>
                        <AlertDialogTrigger asChild>
                          <Button variant="outline" size="sm" className="flex-1 sm:flex-none text-red-600 hover:text-red-700 hover:bg-red-50" disabled={deletingQuote === quote.id}>
                    ...
                    : "Delete"}
                        ...
                        <AlertDialogContent>
                          ...
                          <AlertDialogFooter>
                            ...
                            <AlertDialogAction onClick={() => handleDeleteQuote(quote.id, quote.title)} className="bg-red-600 hover:bg-red-200 hover:text-red-800 text-white">
                              Delete
                            </AlertDialogAction>
                          </AlertDialogFooter>
                        </AlertDialogContent>
