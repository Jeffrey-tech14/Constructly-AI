...
1. COMPREHENSIVE MATERIAL IDENTIFICATION:
   ...
   - Make sure the total amount the extracted materials comes to is equal to the materials cost in the provided data
      ...
      -Make sure the total of the materials you extract comes to the materials cost figure in the provded data, if not retry again and again until the two values match up
