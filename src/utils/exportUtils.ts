...
import { AdvancedMaterialExtractor, MaterialSchedule, } from "@/utils/advancedMaterialExtractor";
...
export const exportQuote = async (options: ExportOptions): Promise<boolean> => {
    try {
        ...
        switch (format) {
            case "pdf":
                return await exportBOQPDF(quote.boq_data, {
                    ...projectInfo,
                }, quote.preliminaries, quote, audience === "client");
            case "excel":
