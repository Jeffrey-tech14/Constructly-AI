const guideSections: GuideSection[] = [
 ...
 <h3 className="text-lg text-white font-normal mb-4">
 How JTech Works
 </h3>
 <p className="text-[#a0a0a0] font-light mb-4">
 ...
 <Card className="bg-transparent border border-[#333] rounded-sm text-white bg-transparent border border-[#333] rounded-sm text-white">
 ...
 <ul className="space-y-2 text-sm text-[#a0a0a0] font-light ">
 ...
 <div className="flex-shrink-0 w-8 h-8 rounded-full bg-[#ef443b] text-white flex items-center justify-center font-bold">
 1
 </div>
 <div>
 ...
 <Card className="bg-transparent border border-[#333] rounded-sm text-white border-amber-200 bg-amber-50 ">
 <CardHeader>
 ...
 <p className="text-sm text-[#a0a0a0] font-light mb-3">
 Temporary works needed before construction starts:
 </p>
 <ul className="text-sm space-y-1 text-[#a0a0a0] font-light ">
 ...
 <div className="space-y-6">
 <div className="bg-[#1a1a1a] border border-[#333] rounded-lg p-6">
 <h3 className="text-lg font-semibold text-white font-normal mb-3">
 ...
 <CardContent className="space-y-4">
 <div>
 <h4 className="text-white font-normal mb-3">
 Required Inputs:
 </h4>
 <div className="space-y-2 text-sm">
 <div className="p-2 bg-[#1a1a1a] rounded border-l-4 border-[#ef443b]">
 ...
 <p className="text-[#a0a0a0] font-light ">4%</p>
 </div>
 <div className="p-2 bg-purple-50 rounded border-l-4 border-purple-500">
 <p className="font-medium">Masonry Wastage:</p>
 <p className="text-[#a0a0a0] font-light ">3%</p>
 </div>
 <div className="p-2 bg-purple-50 rounded border-l-4 border-purple-500">
 ...
 <p className="text-[#a0a0a0] font-light ">7%</p>
 </div>
 <div className="p-2 bg-purple-50 rounded border-l-4 border-purple-500">
 ...
 <CardContent className="space-y-4">
 <div>
 <h4 className="font-semibold text-white font-normal mb-3">
 Required Inputs:
 </h4>
 <div className="space-y-2 text-sm">
 <div className="p-2 bg-amber-50 rounded border-l-4 border-amber-500">
 ...
 <div className="space-y-4">
 <div>
 <h5 className="font-semibold text-white font-normal mb-2">
 ...
 <Card className="bg-transparent border border-[#333] rounded-sm text-white border-amber-200 bg-amber-50 mt-6">
 <CardHeader>
 <CardTitle className="text-base text-amber-900 ">
 ...
 <p className="text-sm text-[#a0a0a0] font-light mt-1">
 ...
 <div className="border-l-4 border-[#ef443b] pl-4 py-2">
 <p className=" text-white font-normal ">
 Equipment Rates
 </p>
 <p className="text-sm text-[#a0a0a0] font-light mt-1">
 ...
 <p className=" text-white font-normal ">Services</p>
 <p className="text-sm text-[#a0a0a0] font-light mt-1">
 ...
 <div className="space-y-3">
 <div className="flex gap-4">
 <div className="flex-shrink-0 w-8 h-8 rounded-full bg-[#ef443b] text-white flex items-center justify-center font-bold text-sm">
 1
 </div>
 <div>
 <p className=" text-white font-normal ">
 ...
 <div className="space-y-2 text-sm bg-[#1a1a1a] p-4 rounded">
 <p className=" text-white font-normal ">
 Information Needed:
 </p>
 <ul className="space-y-1 text-[#a0a0a0] font-light ">
 ...
 <CardContent className="space-y-4">
 <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
 <Card className="bg-transparent border border-[#333] rounded-sm text-white border-[#333] ">
 <CardHeader className="pb-3">
 ...
 <Card className="bg-transparent border border-[#333] rounded-sm text-white border-green-200 ">
 <CardHeader className="pb-3">
 <CardTitle className="text-base">
 Excel Spreadsheet
 </CardTitle>
 ...
 <label
 htmlFor="item1"
 className="text-[#a0a0a0] font-light cursor-pointer"
 >
 ...
 <CardContent className="space-y-4">
 <div className="space-y-3">
 <div className="border-l-4 border-[#ef443b] pl-4">
 <p className=" text-white font-normal ">
 ...
 <CheckCircle2 className="w-5 h-5 text-[#ef443b] mt-0.5 flex-shrink-0" />
 <span className="text-[#a0a0a0] font-light ">
 ...
 <div className="border-l-4 border-purple-500 pl-4 py-2">
 <p className=" text-white font-normal ">Save More</p>
 <p className="text-[#a0a0a0] font-light ">
